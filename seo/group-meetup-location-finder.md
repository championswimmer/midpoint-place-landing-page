...
# Group Meetup Location Finder — Pick a Place That’s Fair
...
- **The "Downtown" Bias**: Suggesting the city center because it's "easy," even though 80% of the group lives in the suburbs.
- **The "Host" Burden**: One person always offers their house, but eventually gets tired of cleaning up.
- **The "Cancel" Cascade**: When the location is annoying to get to, people flake last minute.
...
- **Is it a downtown core?** Great for nightlife and dining.
- **Is it a suburban hub?** Look for malls or large parks.
- **Is it "in the middle of nowhere"?** Zoom out to the nearest town. It's better to drive 5 extra minutes to a good venue than meet at a highway gas station.

### 3. Shortlist and Share
Don't just send one option. Send three:
- **The "Casual" Option**: A coffee shop or park.
- **The "Foodie" Option**: A well-rated restaurant.
- **The "Activity" Option**: Bowling, axe throwing, or arcade.

## Venue strategies for group sizes

- **Small (3-5 people)**: Cafe tables or bar booths. No reservation needed usually.
- **Medium (6-12 people)**: Restaurants with "family style" dining or outdoor beer gardens. Reservations recommended.
- **Large (12+ people)**: Parks, rented pavilions, or private rooms in pubs.
...
- **Recalculate**: It takes seconds to add a new pin and see how the midpoint shifts.
- **Rotate**: If the new midpoint sucks, alternate between the old spot and a new spot closer to the new person.
